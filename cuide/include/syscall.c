...
#define fchdir(fd) syscall(81,fd,0,0,0,0,0)
...
#define mknodat(dirfd,path,mode,dev) syscall(259,dirfd,path,mode,dev,0,0)
...
#define faccessat(dirfd,path,mode,flags) syscall(269,dirfd,path,mode,flags,0,0)
